    ...
    return (
        <main className='contact-box'>
            ...
            <div className='contact-sidebar-box' style={{display:displaySidebar?'flex':'none'}}>
                ...
                <h1 className='contact-title'>Réserve ta séance de massage!</h1>
                <div className='contact-text-box'>
                    <h2 className='reserv-title'>Bloc Shop Chabanel</h2>
                    <p className='contact-text'>1370 rue Chabanel t, Montréal, Québec H4N 1H4</p>
                    <p className='contact-text'>(514) 384-1234</p>
                    <div className='contact-btn-box'> 
                        <button className='home-btn' onClick={goToBS} type='button'>Aller au Bloc Shop!</button>
                ...
                <div className='contact-text-box'>
                    ...
                    <p className='contact-text'>2101 rue Nobel, Sainte-Julie, Québec J3E 1Z8</p>
                    <p className='contact-text'>(450) 922-7734</p>
                    <div className='contact-btn-box'> 
                        <button className='home-btn' onClick={goToHook} type='button'>Aller au Hook!</button>
                        <a className='home-btn' href='https://www.hookbouldering.com/services'>Réserver!</a>
                    </div>
                </div>
            </div>
        </main>
